...
import { signup, login, logout, checkLoggedIn, handleUpdate, handleUserForgot, handleUserForgotSuccess, handleUserReset, handleUserGoogleLogin } from '../controllers/auth.controller.js';
